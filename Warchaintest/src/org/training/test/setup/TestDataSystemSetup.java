...
import org.training.test.constants.WarchainTestConstants;
 ...
 */
@SystemSetup(extension = WarchainTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/Warchaintest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/Warchaintest/import/reviews.impex");
			...
			importImpexFile(context, "/Warchaintest/import/cstickets.impex");
		}
	}
}
