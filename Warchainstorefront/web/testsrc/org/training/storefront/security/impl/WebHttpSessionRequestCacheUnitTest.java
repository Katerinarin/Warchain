...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/Warchainstorefront/electronics/en",
						"https://electronics.local:9002/Warchainstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/Warchainstorefront/electronics/en",
						"https://electronics.local:9002/Warchainstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/Warchainstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/Warchainstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/Warchainstorefront/electronics/en",
						"https://electronics.local:9002/Warchainstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/Warchainstorefront",
						"https://electronics.local:9002/Warchainstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/Warchainstorefront",
						"https://electronics.local:9002/Warchainstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/Warchainstorefront/electronics/en",
						"https://electronics.local:9002/Warchainstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
